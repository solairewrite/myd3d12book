...
void LitWavesApp::UpdateMaterialCBs(const GameTimer& gt)
{
	...
	{
		// Only update the cbuffer data if the constants have changed.  If the cbuffer 如果材质常量数据变化就更新常量缓冲区
...
void LitWavesApp::BuildMaterials()
{
    ...
    // This is not a good water material definition, but we do not have all the rendering 当前这种水的材质定义的不是很好
